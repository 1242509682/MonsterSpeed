      ...
      "时间事件": [
        {
          ...
          "修改防御": 0,
          "行动模式": {
            "模式说明": "0不启用, 1怪物停留原地, 2环绕模式(0顺时针、1逆时针、2根据交替间隔切换顺时针与逆时针), 3徘徊模式, 4突进模式, 5对视模式)",
            "模式类型": 0,
            "平滑系数": 0.15,
            "环绕方向": 0,
            "交替间隔": 180.0,
          ...
          "生成弹幕": [
            {
              ...
              "自定义生成点": [
                {
                  "类型说明": "自定义出生点留空【无法发射弹幕】 0怪物中心, 1玩家中心, 2绝对坐标, 3相对NPC偏移, 4相对玩家偏移, 5上次更新位置",
                  "出生点类型": 0,
                  "坐标": {
                    "X": 0.0,
                    "Y": 0.0
